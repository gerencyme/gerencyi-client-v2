...
export const inputFieldTV = tv({
  base: 'flex outline-none items-center placeholder:text-dark-grey-200/50 text-placeholder:text-dark-grey-200/75',
  variants: {
    variant: {
      mirror:
        'border-[0.5px] px-4 font-poppins text-dark-grey-200 border-dark-grey-200/50 bg-dark-grey-200/10 h-6 rounded-full',
      'side-label':
