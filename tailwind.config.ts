    ...
    extend: {
      backgroundImage: {
        ...
        "home-vertical-gradient":
          "linear-gradient(180deg, #121214 3.5%, rgba(18, 18, 20, 0.7) 15.5%, rgba(42, 42, 42, 0.7) 31.5%, rgba(42, 42, 42, 0.6) 50%, rgba(42, 42, 42, 0.5) 68.5%, rgba(42, 42, 42, 0.4) 84%, rgba(42, 42, 42, 0.3) 100%)",
